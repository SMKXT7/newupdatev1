...
⫹⫺ *🧮 Kelas* : ${global.kelas}
⫹⫺ *🧩 Hobby* : ${global.hobi}
⫹⫺ *💬 Sifat* : Pendiem, Pemalu, Nolep, Ngga suka keramaian, Baik, Suka Menolong jika dibutuhkan:v
⫹⫺ *🗺️ Tinggal* : ${global.tempat}
⫹⫺ *❤️ Waifu* : Nakano Itsuki, Marin Kitagawa, Tsukasa Yukaki, Zero Two, Izzumi Sagiri
